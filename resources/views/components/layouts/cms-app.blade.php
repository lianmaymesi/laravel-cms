    ...
    <x-lb::partials.main max-width="full" :name="$name" :settings-url="$settingsUrl" :initials="$initials" :logo-url="$logoUrl">
        ...
        <x-slot:navigation>
            ...
            @canany(['create menu', 'edit menu', 'delete menu', 'index menu', 'create page', 'edit page', 'delete page',
                ...
                @endcanany
                @canany(['create page', 'edit page', 'delete page', 'index page'])
                    <x-lb::navigate.item title="Pages" path="{{ config('cms.route_prefix') }}/pages*" hierarchy no-navigate>
                        ...
                        @canany(['edit page', 'delete page', 'index page'])
                ...
                @endcanany
                @canany(['create section', 'edit section', 'delete section', 'index section', 'create theme', 'edit theme',
                    'delete theme', 'index theme'])
                    <x-lb::navigate.item title="Themes" path="{{ config('cms.route_prefix') }}/themes*" hierarchy no-navigate>
                        ...
                        @canany(['create theme', 'edit theme', 'delete theme', 'index theme'])
                        ...
                        @endcanany
                        @canany(['edit section', 'delete section', 'index section'])
